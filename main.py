...
# Override the torch.load function to disable weights_only=True
torch_load = torch.load  # Backup the original function
def custom_torch_load(*args, **kwargs):
    kwargs["weights_only"] = False  # Force loading full model
    return torch_load(*args, **kwargs)

torch.load = custom_torch_load  # Override the function
